...
const EmployeerMenuWrapper = ({menu, loading, employees, cities, categories, banks, recipts, addEmployee, getEmployee, getCities, getCategories, getBanks, setEmployeeToPay, searchRecipt})=>{
  switch (menu) {
    case 'add':
    ...
    case 'receipt':
      return <SearchReciptsForm loading={loading} recipts={recipts} searchRecipt={searchRecipt}/>
  }
}
